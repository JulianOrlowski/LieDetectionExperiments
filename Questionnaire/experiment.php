    ...
    <body onload="Init();">
        ...
        if (isset($_POST["ques_submit"])){
		    ...
		    //echo "<script>location='../thanks.php';</script>";
                    ...
                    $sql_update_session=mysqli_query($conn, "update sessions_long set current_question_index = '".$question_Index_Post."',current_block_number = '".$current_Blocknumber."' where session_id =".$session_ID_Post."");
                    //jump to which page
                    if($question_Index_Post==3){
