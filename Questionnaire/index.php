...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body onload="FocusOnInput()">
        ...
        if (isset($_POST["submitRegister"])){
            ...
            $sql_Register=mysqli_query($conn, "insert into sessions_long(age,sex,phone_condition,mind_condition,education_level,pc_usage,device_info,question_ids_sequence,current_question_index,current_block_number,completed,start_time) values('".$_POST['subjectAge']."','".$_POST['subjectSex']."','".$_POST['phoneCondition']."','".$_POST['subjectCondition']."','".$_POST['subjectEducation']."','".$_POST['subjectPcusage']."','".$devices."','".$string_Sequence."','0','0','0','". $date_CreateSession."')");           
