           ...
           <form class="form-horizontal" action="" method="post" name="theForm" style="margin-bottom: 0px;" onsubmit="return chk(this)" autocomplete="off">     
            <div class="form-group">
                    ...
                    <label class="radio-inline">
                        <input name="subjectCondition" type="radio" id="0" value="1" checked="checked" /> Sincero</label>
                    <label class="radio-inline">
                        <input type="radio" name="subjectCondition" value="2" id="1" />Mentitore (falsa identità)</label>
                    </div>
		    <label class="radio-inline">
                        <input type="radio" name="subjectCondition" value="3" id="2" />Mentitore</label>
                    </div>
            </div>                     
        <div class="col-xs-12">
