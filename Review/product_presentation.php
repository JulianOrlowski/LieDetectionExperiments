    ...
    <body>
        ...
        <form action="" method="post" name="informForm"  style="margin-bottom:0px;" >
            <table class=" table table-striped">
                <tr>
                    <td class="text-center" bgcolor="#EBEBEB">
                    <img src="images/motorola.jpg" class="responsive" height="100dp" width="100dp">
                    </td>
                </tr>
                <tr >
                    <td  align="left" bgcolor="#FFFFFF" >
                        <p class="text-justified">
                            Non sai niente di questo telefono eccetto il suo prezzo (300€). Devi scrivere una recensione su di esso.<br/><br/>
                            <br/>Buon lavoro!</p>                    
                    </td>
                </tr>
                <tr>
